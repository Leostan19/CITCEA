...
def func_obj(m):
    return m.PVG*0.01+m.purchasedelectricity*0.05-0.025*(m.soldelectricity)
...
print("total cost =", model.PVG()*0.01+model.purchasedelectricity()*0.05-0.025*(model.soldelectricity()))
